    ...
    return(
        ...
        <form className={`contact__form w-100 rounded-4 ${style.form}`}>
            <div className={`row mt-4 w-100 ${style.paddingForm}`}>
                <div className={`col-sm-12 col-md-7 col-lg-6 form-group ${style.search_div} ${style.form_m}`}>
                ...
                <div className={`col-sm-6 col-md-3 col-lg-2 form-group  ${style.form_m}`}>
                    <input 
                            className={`${style.form_control} ${style.search_name}`}
                            id="zip"
                            name="zip"
                ...
                {/* <div className={`col-sm-6 col-md-2 col-lg-2 form-group  ${style.form_m}`}> */}
                    <select className={`col-sm-6 col-md-2 col-lg-2 form-group ${style.filterRent} ${style.form_m}`} >
           ...
           <div className={`row mt-4 w-100 ${style.paddingForm}`}>
           <label className={`col-sm-12 col-md-7 col-lg-4 ${style.rentLabel}`}>Living area</label>
           <label className={`col-sm-12 col-md-7 col-lg-4 ${style.rentLabel}`}>Type</label>
           <label className={`col-sm-12 col-md-7 col-lg-4 ${style.rentLabel}`}>Gender</label>
           ...
           <div className={`row mt-2 w-100 ${style.paddingForm}`}>
                <div className={`col-sm-12 col-md-7 col-lg-4 form-group ${style.search_div} ${style.form_m}`}>
                    <input 
                            className={`${style.form_control} ${style.search_name}`}
                            id="name"
                            name="name"
                ...
                <div className={`col-sm-6 col-md-2 col-lg-4 form-group ${style.divSelectRent} ${style.form_m}`}>
